...
<head>
    ...
    <title>Viết truyện - Kid Social</title>
    ...
    <style>
        ...
        .story-tips h6 svg { width: 20px; height: 20px; }
        .story-tips ul {
            margin-bottom: 0;
            color: #b3c6ff;
        }
        ...
        @media (max-width: 700px) {
            .story-container { padding: 1.2rem 0.5rem; }
        }
    </style>
</head>
<body>
    ...
    <div class="story-container">
        <div class="page-header">
            <h1>
                ...
                <svg width="36" height="36" viewBox="0 0 48 48" fill="none"><circle cx="24" cy="24" r="12" fill="#a259ff" opacity="0.7"/><rect x="32" y="12" width="6" height="2" rx="1" fill="#ffe156"/><path d="M30 18l-8 8" stroke="#ffe156" stroke-width="2"/></svg>
                Viết truyện
            </h1>
            <p class="text-muted">Sáng tạo những câu chuyện thú vị và chia sẻ với bạn bè</p>
        </div>
        <!-- Thông báo -->
        ...
        <div class="story-tips">
            <h6>
                <!-- SVG: Bóng đèn -->
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"><circle cx="10" cy="10" r="8" fill="#ffe156" stroke="#3cf2ff" stroke-width="1.5"/><path d="M10 2v2" stroke="#a259ff" stroke-width="2" stroke-linecap="round"/><path d="M10 16v2" stroke="#a259ff" stroke-width="2" stroke-linecap="round"/><path d="M2 10h2" stroke="#a259ff" stroke-width="2" stroke-linecap="round"/><path d="M16 10h2" stroke="#a259ff" stroke-width="2" stroke-linecap="round"/></svg>
                Gợi ý viết truyện:
            </h6>
            <ul>
                <li>Viết ít nhất 50 ký tự để tạo một câu chuyện hoàn chỉnh</li>
                <li>Thêm hình ảnh minh họa để truyện thêm sinh động</li>
                <li>Kể về những điều thú vị xảy ra trong ngày của bạn</li>
                <li>Chia sẻ những ước mơ và suy nghĩ của mình</li>
            </ul>
        </div>
        <form method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/kid/story">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="title" name="title" 
                       placeholder="Nhập tiêu đề cho câu chuyện của bạn..." required>
            </div>
            <div class="form-group">
                ...
                <textarea class="form-control" id="content" name="content" rows="10" 
                          placeholder="Viết câu chuyện của bạn ở đây..." required 
                          oninput="updateWordCount()"></textarea>
                <div class="word-count" id="wordCount">0 ký tự</div>
            </div>
            <div class="form-group">
                ...
                <div class="file-upload">
                    <input type="file" id="illustration" name="illustration" accept="image/*" onchange="previewImage(this)">
                    <label for="illustration" class="file-upload-label">
                        <!-- SVG: Cloud upload -->
                        ...
                        <div class="mt-2">
                            <strong>Chọn hình ảnh minh họa</strong>
    ...
    <script>
        function updateWordCount() {
            ...
            wordCount.textContent = charCount + ' ký tự';
        ...
        document.querySelector('form').addEventListener('submit', function(e) {
            ...
            if (content.length < 50) {
                e.preventDefault();
                alert('Nội dung truyện phải có ít nhất 50 ký tự. Hiện tại bạn đã viết ' + content.length + ' ký tự.');
                return false;
            }
        });
    </script>
